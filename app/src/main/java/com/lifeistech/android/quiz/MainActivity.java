...
public class MainActivity extends ActionBarActivity {
    ...
    private void makeQuestions() {
        ...
        Question q6 = new Question(R.drawable.pooh,"この都道府県は？","そもそも都道府県じゃない","千葉","福島");
    ...
    private void nextQuestion() {
        ...
        // TODO [04] ここから
        status.setText(String.valueOf(current) + "問中" + String.valueOf(correct_num) + "問正解" + "残り" + String.valueOf(question_num - current) + "問");
